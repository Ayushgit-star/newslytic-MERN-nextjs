            ...
            <tbody>
              {[1, 2, 3, 4, 5, 6, 7, 8, 9].map((n, i) => (
                <tr key={i} className="bg-white border-b">
                  ...
                  <td className="px-6 py-4">India gets its longest glass...</td>
                  <td className="px-6 py-4">
                    <img src="nill" alt="Img" className="w-[40px] h-[40px]" />
                  </td>
                  <td className="px-6 py-4">Travel</td>
                  <td className="px-6 py-4">You all must have ...</td>
                  <td className="px-6 py-4">June 30, 2004</td>
                  <td className="px-6 py-4">
